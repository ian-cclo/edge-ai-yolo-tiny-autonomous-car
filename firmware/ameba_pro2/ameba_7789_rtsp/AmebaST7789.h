...
public:
    ...
    void setOffset(uint16_t xstart, uint16_t ystart);  // 新增：動態設定面板偏移
    inline int16_t width()  { return getWidth(); }     // (順手加) 與 Adafruit API 對齊
    inline int16_t height() { return getHeight(); }
